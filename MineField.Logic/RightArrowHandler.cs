...
{
    /// <summary>
    /// The class to handle to a right arrow key press.
    /// </summary>
    public class RightArrowHandler : BaseInputHandler, IUserInputHandler
    {
        /// <summary>
        /// Updates the game data to store the result of a right arrow key press.
        /// </summary>
        /// <returns></returns>
        public string UpdateCurrentGameData(GameData gameData)
        {
            ...
            if (currentPosition.Column + 1 > GridSize)
            {
                return GetMessageForUser(gameData, UserMessages.OffTheRightOfTheBoard);
            }
